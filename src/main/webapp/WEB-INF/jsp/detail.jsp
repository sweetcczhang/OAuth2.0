			 ...
			 <div class="panel-heading"><p style="font-size:20px">应用详细资料</p></div>
				<div class="panel-body">
					...
					<div class="form-group">
						...
						<div class="col-md-7">	
							<label class="control-label">${innerInfoBean.appName }</label>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-md-7">	
							<label class="control-label">${innerInfoBean.appId }</label>
						</div>
					</div>
										...
										<div class="form-group">
											...
											<div class="col-md-7">	
												<label class="control-label">${innerInfoBean.appSecret }</label>
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-md-7">	
											<label class="control-label">${innerInfoBean.appUrl }</label>
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-md-7">	
												<label class="control-label">${innerInfoBean.redirectUrl }</label>
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-md-7">	
												<label class="control-label">${innerInfoBean.createTime }</label>
											</div>
										</div>
							</div>			
