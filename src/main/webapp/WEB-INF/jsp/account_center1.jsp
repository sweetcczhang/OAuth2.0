			...
			<div class="panel panel-default" style="height:700px">
				<div class="panel-body">
					<div class="list-group" style="margin:-16px -16px -16px -16px">
						...
						<a class="list-group-item" href="<%=basePath %>change/accountCenterController2" >修改用户资料</a>
						<a class="list-group-item" href="#Opera" data-toggle="tab">修改开发者资料</a>
					</div>
				</div>
			</div>
			...
			<div class="panel panel-default">
				<div class="panel-body">
                   ...
                   <!-- tab 第二个 哈哈哈                      -->
						...
						<div class="tab-pane fade in active" id="Opera">
							<h4 class="page-header" style="margin-top:10px">开发者资料修改</h4>
								<form:form  class="form-horizontal" action="updateDveloper" commandName="developerBean" method="post">
										...
										<div class="form-group">
											<label for="label2" class="col-md-2 control-label">公司名称:</label>
											<div class="col-md-7">	
												<form:input   class="form-control" id="label2" path="companyName"/> 
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-md-7">	
												<form:input type="text" class="form-control" id="qqNumber" path="qq"/>
											</div>
										</div>
										<hr>
										<div class="form-group">
