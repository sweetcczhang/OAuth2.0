			...
			<div class="panel panel-info" >
			 <div class="panel-heading"><p style="font-size:20px">应用基本资料填写</p></div>
				<div class="panel-body">
					...
					<form:form class="form-horizontal" modelAttribute="appInfoBean"  method="post">
						...
						<div class="form-group">
							<label for="label4" class="col-md-2 control-label">应用回掉地址</label>
							<div class="col-md-7">	
							<form:input class="form-control" id="label4" path="redirectUrl"/>
						...
						<div class="form-group">
							<label for="label5" class="col-md-2 control-label">上传图片</label>
							<div class="col-md-7">	
							<input type="file"  id="label5" name="image">
							</div>
						</div>
						<br>
						<div class="form-group">
