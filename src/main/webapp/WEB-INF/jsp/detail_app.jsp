			 ...
			 <div class="panel-heading"><p style="font-size:20px">应用详细资料</p></div>
				<div class="panel-body">
					...
					<div class="form-group">
						...
						<div class="col-md-7">	
							<label class="control-label">${appInfoBean.appName }</label>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-md-7">	
							<label class="control-label">${appInfoBean.appId }</label>
						</div>
					</div>
										...
										<div class="form-group">
											...
											<div class="col-md-7">	
												<label class="control-label">${appInfoBean.appSecret }</label>
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-md-7">	
											<label class="control-label">${appInfoBean.appUrl }</label>
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-md-7">	
												<label class="control-label">${appInfoBean.redirectUrl }</label>
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-md-7">	
												<label class="control-label">${appInfoBean.createTime }</label>
											</div>
										</div>
							</div>			
