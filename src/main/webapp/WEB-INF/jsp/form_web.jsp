			...
			<div class="panel panel-info" >
			 <div class="panel-heading"><p style="font-size:20px">应用基本资料填写</p></div>
				<div class="panel-body">
					...
					<form:form class="form-horizontal" modelAttribute="clientBean"  method="post">
						<form:hidden path="id"/>
						...
						<div class="form-group">
							<label for="label1" class="col-md-2 control-label">网站名称</label>
							<div class="col-md-7">	
							<form:input class="form-control" id="label1" path="clientName"/>
							<form:errors path="clientName"></form:errors>
							<p class="help-block" style="margin-top:5px;color:#eee9e9"><br></p>
							</div>
						</div>
						<div class="form-group">
							<label for="label2" class="col-md-2 control-label">网站描述</label>
							<div class="col-md-7">	
					  <!--		<input type="text" rows="3" class="form-control" id="label1">  -->
						...
						<div class="form-group">
							<label for="label3" class="col-md-2 control-label">网站地址</label>
							<div class="col-md-7">	
							<form:input class="form-control" id="label3" path="webUrl"/>
							<form:errors path="webUrl"></form:errors>
							<p class="help-block" style="margin-top:5px;color:#eee9e9"><br></p>
							</div>
						</div>
						
						<div class="form-group">
							<label for="callBack_url" class="col-md-2 control-label">回掉地址</label>
							<div class="col-md-7">	
							<form:input class="form-control" id="callBack_url" path="redirectUrl"/>
