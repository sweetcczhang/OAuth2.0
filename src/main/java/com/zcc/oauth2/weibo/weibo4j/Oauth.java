...
import com.zcc.oauth2.weibo.http.BASE64Encoder;
...
//	public String client_id="4049267498";
//	public String client_secret="2fae447e1dfbc5076c1981eb1dc90ae6";
//  public String redirect_uri="http://localhost:8400/sweet-smile.zcc/happy";
...
//  public String baseUrl="https://api.weibo.com/2/";
	...
	public AccessToken getAccessTokenByCode(String code) throws WeiboException {
		System.out.println("accessTokenUrl:"+WeiboConfig.getValue("accessTokenURL"));
